		...
		while(busca == 0) {
				...
				if(poder[round][2] == 0) {
					...
					if(escolha == 0) {
						if(g.velocidade > poder[round][0]) {
							JOptionPane.showMessageDialog(null, "Parabens, você derrotou " + pers.oponente(round));
							vitoria++;
						}else {
							JOptionPane.showMessageDialog(null, "Infelizmente, voce foi derrotado por  " + pers.oponente(round));
							derrota++;	
							vidas--;
							JOptionPane.showMessageDialog(null, "Vitorias: " + vitoria + " - Derrotas: " + derrota + " Vidas: " + vidas);
			...
			if(lutasRealizadas == poder.length) {
				...
				if(vitoria == poder.length) {
					JOptionPane.showMessageDialog(null, "Parabens " + g.guerreiro + ", Voce provou ser o melhor Guerreiro da Arena");
					JOptionPane.showMessageDialog(null, "Vitórias: " + vitoria + " Derrotas " + derrota + " Vidas: " + vidas);
				}else {
					JOptionPane.showMessageDialog(null, "Parabens " + g.guerreiro + ", Voce chegou na final. Considere um vencedor");
					JOptionPane.showMessageDialog(null, "Vitorias: " + vitoria + " - Derrotas: " + derrota + " Vidas: " + vidas);
