...
public class Personagem {
	...
	protected String[]oponente = {"Mamba Negra", "Chacal do Deserto", "Dama da Morte", "Naja",
			  ...
			  "Morte Certa", "Monstro do Pantano"};
	...
	public int figura(int oponente) {
		...
		if(oponente == 0) {
			...
			arma = JOptionPane.showOptionDialog(
		            null,
		            "Seu Oponente é " + this.oponente[oponente] + " Escolha entre Velocidade ou Forca:",
		            "Escolha Atributo",
		...
		if(oponente == 1) {
			...
			arma = JOptionPane.showOptionDialog(
		            null,
		            "Seu Oponente e " + this.oponente[oponente] + " Escolha entre Velocidade ou Forca:",
		            "Escolha Atributo",
		            JOptionPane.DEFAULT_OPTION,
		            JOptionPane.QUESTION_MESSAGE,
		            null,
